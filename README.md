...
LLM-empowered emotion-gated mixture-of-experts framework for safe lane-change decision of autonomous driving

Files

EOS_STPA_ICM_SRM_CSM.pdf: Three-layer scenario–system interaction modeling for lane changing based on EOS-STPA: (a) ICM; (b) SRM; (c) CSM.
